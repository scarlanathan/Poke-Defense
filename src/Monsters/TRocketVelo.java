...
public class TRocketVelo extends AEnemy{

    public TRocketVelo(int x, int y, int id,MonsterControler monsterControler) {
        super(x, y, id, TROCKETVELO,monsterControler);
        super.health = 100;
        super.maxHealth = 100;
    }
